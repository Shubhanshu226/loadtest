...
const COLLECTION_VARS = {"baseUrl":"http://localhost:3000","graphqlPath":"/graphql","basicAuthToken":"REPLACE_WITH_BASE64_USERNAME_PASSWORD","email":"user@example.com","password":"Password@123","authToken":""};
const EXTRACTIONS = [{"match":"/Login/i","jsonPath":"$.data.login.authToken","var":"authToken"},{"match":"/Current Session/i","jsonPath":"$.data.currentSession.accessToken","var":"accessToken"}];
